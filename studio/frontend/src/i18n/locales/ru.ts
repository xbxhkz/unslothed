...
export const ru = {
  ...
  shell: {
    ...
    selection: {
      ...
      deleteProjectFolderKeptDescription:
        "Чаты будут удалены. Выбранная вами папка ({path}) останется на диске.",
  ...
  settings: {
    ...
    dialog: {
      title: "Настройки",
      description: "Управление настройками Unslothed.",
    ...
    voice: {
      ...
      dictation: {
        ...
        micAccessBlocked:
          "Доступ к микрофону заблокирован. Разрешите доступ к микрофону для этой страницы Unslothed и повторите попытку.",
    ...
    general: {
      title: "Общие",
      description: "Глобальные настройки Unslothed.",
      account: "Аккаунт",
      ...
      password: "Пароль",
      passwordDescription: "Изменить пароль для этого аккаунта Unslothed.",
      passwordDialog: {
        ...
        setDescription:
          "Выберите пароль, с которым удалённые браузеры входят как unsloth (не менее {minLength} символов). Настольное приложение Unslothed продолжит входить автоматически.",
      ...
      startup: {
        ...
        launchAtLogin: "Запускать Unslothed при входе в систему",
        launchAtLoginDescription:
          "Запускает Unslothed в фоновом режиме при входе в систему. Приложение остаётся в строке меню или системном трее, пока вы его не откроете.",

        closeToTray: "Закрывать в системный трей",
        closeToTrayDescription:
          "Оставлять Unslothed и его сервер работающими в фоне при закрытии главного окна.",
      ...
      resetPreferences: {
        ...
        confirmDescription:
          "Очищает только локальные настройки и перезагружает Unslothed. Чаты, доступ по API и настройки в базе данных сохраняются.",
      ...
      permissions: {
        ...
        bypassDescription:
          "Как Unslothed подтверждает вызовы инструментов в чате (терминал, python, веб, MCP) перед запуском. Режим «Full access» отключает подтверждения и песочницу для кода.",
      },
    },
    profile: {
      title: "Профиль",
      description: "Как ваш профиль отображается в Unslothed.",
      changePicture: "Изменить фото профиля",
      displayName: "Отображаемое имя",
      nickname: "Как Unslothed к вам обращаться?",
      ...
      stats: {
        ...
        subtitle:
          "Всё ниже считается по вашей собственной истории. Ничего не собирается и не отправляется в Unslothed.",
        retry: "Повторить",
        privacyNote:
          "Статистика рассчитывается по истории чатов и обучения, которая хранится в вашей установке Unslothed. Ничего не собирается и ничего не отправляется ни в Unslothed, ни третьим лицам.",
        emptyChats:
    ...
    appearance: {
      title: "Оформление",
      description: "Как Unslothed выглядит на этом устройстве.",
      theme: {
        title: "Тема",
      ...
      palette: {
        ...
        description: "Цвета, используемые в Unslothed в светлой и тёмной теме.",
      ...
      custom: {
        ...
        uiFontSize: {
          ...
          description: "Настройте базовый размер шрифта интерфейса Unslothed.",
        },
        codeFontSize: {
      ...
      language: {
        ...
        description: "Язык, используемый Unslothed.",
    ...
    resources: {
      title: "Система",
      description: "Мониторинг оборудования и хранилища этого сервера Unslothed.",
      ...
      llamaBackend: {
        ...
        customPath: {
          ...
          bundled: "Используется среда llama.cpp, установленная Unslothed.",
        ...
        unsupported: {
          ...
          localLink: "llama.cpp, это локальный каталог, который вы подключили сами, и Unslothed его не заменяет.",
    ...
    agents: {
      ...
      intro:
        "подключает Claude Code, Codex, Hermes, OpenClaw, OpenCode и других агентов к модели, которую Unslothed обслуживает локально, полностью офлайн. Запускается OpenAI-совместимый сервер, а файлы конфигурации вашего агента остаются нетронутыми.",
      ...
      modelNote:
        "Codex требует модель GGUF, обслуживаемую llama-server. Другие агенты могут работать и с моделями на основе transformers; уберите --model, чтобы использовать модель, уже загруженную в Unslothed.",
      subagent: {
        title: "Использовать локальную модель в качестве субагента",
        description:
          "Оставьте {agent} на текущей модели и делегируйте отдельные задачи этой локальной модели Unslothed.",
      ...
      options: {
        ...
        description:
          "Сначала разбираются флаги Unslothed; всё, что не распознано, передаётся агенту без изменений.",
        model:
        ...
        persist:
          "Сохраняет между запусками хранилище агента, управляемое Unslothed.",
        asSubagent:
          "Оставляет родительского агента на текущей модели и регистрирует Unslothed как локального субагента (Claude Code, Codex и OpenCode).",
        apiKey:
          "Передаёт ваш ключ API Unslothed (альтернатива: переменная UNSLOTH_API_KEY).",
        yolo:
      ...
      passthrough: {
        ...
        description:
          "Аргументы после флагов Unslothed передаются самому агенту, поэтому его собственные команды вроде resume продолжают работать:",
      },
      dryRun: {
    ...
    apiKeys: {
      title: "API",
      description: "Доступ к Unslothed через OpenAI-совместимый API.",
      ...
      secureHttpsHint:
        "Порт, привязанный к адресу 0.0.0.0, по-прежнему доступен глобально. Для полной безопасности запустите Unslothed с флагом --secure, чтобы оставить доступ только по этой HTTPS-ссылке.",
    ...
    about: {
      ...
      studioVersion: "Версия Unslothed",
      ...
      shutDownStudio: "Выключить Unslothed",
      shutDownStudioDescription:
        "Останавливает сервер Unslothed и завершает вашу сессию.",
      shutDown: "Выключить",
      update: {
        title: "Обновить Unslothed",
        commandText: "Текст «{label}»",
        copied: "Скопировано",
        copyCommand: "Копировать команду",
        commandCopied: "Скопировано: {label}",
        copyNamedCommand: "Копировать «{label}»",
        checkingInstall: "Проверка способа установки Unslothed...",
        installIntro: "Чтобы установить или обновить Unslothed:",
        ...
        localInstallDetected:
          "Обнаружена установка из локальной рабочей копии. Обновляйте Unslothed из исходной рабочей копии, чтобы не заменить эту установку пакетом из PyPI.",
        pullThenUpdate:
        ...
        restartAfterUpdate: "После обновления перезапустите Unslothed.",
        desktopManaged:
        ...
        desktopCurrentDescription:
          "Unslothed продолжит автоматически проверять наличие обновлений.",
        ...
        unknownInstall:
          "Не удалось определить способ установки Unslothed. Для установки через установщик или PyPI используйте команды выше.",
        localCheckout:
  ...
  studio: {
    ...
    training: {
      ...
      startUnconfirmed:
        "Unslothed не удалось подтвердить запуск обучения. Состояние проверяется в фоновом режиме.",
  ...
  toolAudit: {
    title: "Активность инструментов",
    empty: "Пока не зафиксировано ни одного вызова инструмента.",
    loadError: "Не удалось загрузить активность инструментов. Повторите попытку.",
    degraded:
      "Не удалось записать некоторые записи аудита ({count}). Журнал неполон.",
    filterTool: "Фильтр по инструменту",
    filterAll: "Все инструменты",
    columnTime: "Время",
    columnTool: "Инструмент",
    columnOutcome: "Статус",
    columnDuration: "Длительность",
    outcomeRunning: "выполняется",
    outcomeOk: "успешно",
    outcomeError: "ошибка",
    redactedBadge: "скрыто",
    sandboxBypassBadge: "песочница обойдена",
    argumentsHeading: "Аргументы",
    resultHeading: "Результат",
    errorHeading: "Ошибка",
    truncatedNote: "Показаны первые и последние 4 КБ из {bytes} байт.",
    refresh: "Обновить",
  },
