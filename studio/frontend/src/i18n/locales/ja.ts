  ...
  chat: {
    draftModelPicker: {
      autoLoadFallbackNote:
        "実行設定からの読み込みに適用されます。自動的な読み込み（API による自動切り替え、アイドル時の再読み込み、チャット設定の適用）では、代わりに自動検出されたドラフトモデルが選択されます。",
    },
  },
  toolAudit: {
    title: "ツールアクティビティ",
    ...
    outcomeError: "エラー",
    redactedBadge: "編集済み",
    sandboxBypassBadge: "サンドボックス回避",
    argumentsHeading: "引数",
    resultHeading: "結果",
    errorHeading: "エラー",
    truncatedNote: "{bytes} バイトのうち、先頭と末尾の4KBを表示しています。",
    refresh: "更新",
  },
