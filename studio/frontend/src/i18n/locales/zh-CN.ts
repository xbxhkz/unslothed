...
export const zhCN = {
  ...
  settings: {
    ...
    dialog: {
      title: "设置",
      description: "管理你的 Unslothed 偏好设置。",
      closeAriaLabel: "关闭设置",
    ...
    voice: {
      ...
      dictation: {
        ...
        micAccessBlocked:
          "麦克风访问已被阻止。请在浏览器中允许此 Unslothed 页面使用麦克风，然后重试。",
    ...
    general: {
      ...
      password: "密码",
      passwordDescription: "更改此 Unslothed 账号的密码。",
      passwordDialog: {
        trigger: "更改密码",
        title: "更改密码",
        ...
        setTitle: "设置远程密码",
        setDescription:
          "选择远程浏览器以 unsloth 身份登录时使用的密码（至少 {minLength} 个字符）。Unslothed 桌面应用仍会自动登录。",
        setSubmit: "设置密码",
        setting: "正在设置...",
        setDone: "密码已设置。",
      ...
      startup: {
        sectionTitle: "启动",
        launchAtLogin: "登录时运行 Unslothed",
        launchAtLoginDescription:
          "登录系统时在后台启动 Unslothed。在你打开它之前，它会一直驻留在菜单栏或系统托盘中。",

        closeToTray: "关闭到系统托盘",
        closeToTrayDescription:
          "关闭主窗口时，让 Unslothed 及其服务器继续在后台运行。",
      ...
      resetPreferences: {
        ...
        confirmDescription:
          "这会清除仅保存在本地的偏好设置，然后重新加载 Unslothed。聊天、API 访问权限和数据库中的设置不会受到影响。",
      ...
      permissions: {
        ...
        bypassLabel: "工具权限",
        bypassDescription:
          "设置 Unslothed 执行聊天中的工具调用（终端、python、网页、MCP）前的审批方式。“Full access”会关闭审批和代码沙箱。",
      },
    },
    profile: {
      title: "个人资料",
      description: "你的个人资料在 Unslothed 中的显示方式。",
      changePicture: "更换头像",
      displayName: "显示名称",
      nickname: "Unslothed 应该怎么称呼你？",
      ...
      stats: {
        title: "你的统计",
        subtitle:
          "下面的内容全部根据你自己的历史记录统计。不会收集任何数据，也不会发送给 Unslothed。",
        retry: "重试",
        privacyNote:
          "统计数据由你本地 Unslothed 保存的聊天和训练历史计算得出。不收集任何数据，也不会发送给 Unslothed 或任何第三方。",
    ...
    appearance: {
      title: "外观",
      description: "调整 Unslothed 在此设备上的显示方式。",
      language: {
        title: "语言",
        label: "显示语言",
        description: "选择 Unslothed 使用的语言。",
        autoDetect: "自动检测",
      },
      theme: {
        title: "主题",
      ...
      palette: {
        label: "调色板",
        description: "Unslothed 全局使用的配色，支持浅色和深色模式。",
        standard: "标准",
        classic: "经典",
        minimal: "极简",
      },
      custom: {
        ...
        uiFontSize: {
          label: "界面字号",
          description: "调整 Unslothed 界面的基准字号。",
        },
        codeFontSize: {
          label: "代码字号",
    ...
    resources: {
      title: "系统",
      description: "监控此 Unslothed 服务器的硬件和存储。",
      liveUpdates: "实时更新",
      floatingWindow: "悬浮窗口",
      ...
      llamaBackend: {
        ...
        customPath: {
          ...
          automatic: "自动（内置）",
          bundled: "使用 Unslothed 安装的 llama.cpp 运行时。",
        ...
        unsupported: {
          ...
          localLink: "llama.cpp 是你自己链接的本地目录，Unslothed 不会替换它。",
    ...
    agents: {
      ...
      intro:
        "可将 Claude Code、Codex、Hermes、OpenClaw、OpenCode 等智能体连接到由 Unslothed 在本地提供服务的模型，全程离线。它会启动一个兼容 OpenAI 的服务器，并且从不改动智能体的配置文件。",
      readDocs: "查看文档",
      copy: "复制",
      copied: "已复制",
      ...
      modelNote:
        "Codex 需要通过 llama-server 提供服务的 GGUF 模型。其他智能体也可以使用基于 transformers 的模型；去掉 --model 即可使用 Unslothed 中已加载的模型。",
      subagent: {
        title: "将本地模型用作子智能体",
        description:
          "让 {agent} 保持当前模型，并把选定的任务委派给这个本地 Unslothed 模型。",
        setupCommand: "配置命令",
      ...
      options: {
        title: "常用选项",
        description:
          "Unslothed 的参数会先被解析；无法识别的参数会原样传给智能体。",
        model:
        ...
        persist: "在多次运行之间保留由 Unslothed 管理的智能体存储。",
        asSubagent:
          "让父智能体保持当前模型，并将 Unslothed 注册为本地子智能体（Claude Code、Codex 和 OpenCode）。",
        apiKey: "提供你的 Unslothed API 密钥（或设置 UNSLOTH_API_KEY）。",
      ...
      passthrough: {
        title: "向智能体传递参数",
        description:
          "Unslothed 参数之后的参数会转发给智能体本身，因此 resume 之类的原生命令仍然可用：",
      },
      dryRun: {
        title: "仅预览，不启动",
        description:
    ...
    apiKeys: {
      title: "API",
      description: "通过兼容 OpenAI 的 API 以编程方式访问 Unslothed。",
      readDocs: "阅读 API 文档",
      ...
      secureHttpsHint:
        "0.0.0.0 端口仍可被全网访问。如需完全安全，请使用 --secure 启动 Unslothed，仅暴露此 HTTPS 链接。",
    ...
    about: {
      title: "关于",
      description: "文档、发布说明、反馈和 Unslothed 构建信息。",
      studioVersion: "Unslothed 版本",
      packageVersion: "包版本",
      ...
      dangerZone: "危险区域",
      shutDownStudio: "关闭 Unslothed",
      shutDownStudioDescription: "停止 Unslothed 服务进程并结束你的会话。",
      shutDown: "关闭",
      update: {
        title: "更新 Unslothed",
        ...
        checkingInstall: "正在检查 Unslothed 的安装方式...",
        installIntro: "安装或更新 Unslothed：",
        ...
        restartAfterUpdate: "更新后请重启 Unslothed。",
        desktopManaged:
        ...
        desktopCurrentDescription: "Unslothed 会继续自动检查更新。",
        ...
        unknownInstall:
          "Unslothed 无法检测安装方式。如果你使用一键安装器或 PyPI 安装，请使用上面的命令。",
        localCheckout:
  ...
  studio: {
    ...
    training: {
      ...
      startFailed: "启动训练失败",
      startUnconfirmed: "Unslothed 无法确认训练是否已开始。正在后台检查状态。",
      stopFailed: "停止训练失败",
  ...
  toolAudit: {
    ...
    outcomeError: "错误",
    redactedBadge: "已脱敏",
    sandboxBypassBadge: "已绕过沙箱",
    argumentsHeading: "参数",
    resultHeading: "结果",
    errorHeading: "错误",
    truncatedNote: "显示 {bytes} 字节中的前后各 4 KB。",
    refresh: "刷新",
  },
