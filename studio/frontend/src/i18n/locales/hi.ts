...
export const hi = {
  ...
  shell: {
    ...
    selection: {
      ...
      deleteProjectFolderKeptDescription:
        "चैट हटा दी जाएँगी। आपके द्वारा चुना गया फ़ोल्डर ({path}) डिस्क पर बना रहेगा।",
  ...
  settings: {
    ...
    dialog: {
      title: "सेटिंग्स",
      description: "अपनी Unslothed प्राथमिकताएँ प्रबंधित करें।",
    ...
    voice: {
      ...
      dictation: {
        ...
        micAccessBlocked:
          "माइक्रोफ़ोन एक्सेस रोक दिया गया है। इस Unslothed पेज के लिए माइक्रोफ़ोन एक्सेस की अनुमति दें, फिर दोबारा कोशिश करें।",
    ...
    general: {
      title: "सामान्य",
      description: "Unslothed के लिए वैश्विक प्राथमिकताएं।",
      account: "खाता",
      ...
      password: "पासवर्ड",
      passwordDescription: "इस Unslothed खाते के लिए पासवर्ड बदलें।",
      passwordDialog: {
        ...
        setDescription:
          "वह पासवर्ड चुनें जिससे रिमोट ब्राउज़र unsloth के रूप में साइन इन करते हैं (कम से कम {minLength} अक्षर)। Unslothed डेस्कटॉप ऐप स्वतः साइन इन करता रहेगा।",
      ...
      startup: {
        ...
        launchAtLogin: "लॉगिन पर Unslothed चलाएं",
        launchAtLoginDescription:
          "लॉगिन करने पर Unslothed को बैकग्राउंड में शुरू करता है। इसे खोलने तक यह मेनू बार या सिस्टम ट्रे में रहता है।",

        closeToTray: "सिस्टम ट्रे में बंद करें",
        closeToTrayDescription:
          "मुख्य विंडो बंद करने पर Unslothed और उसके सर्वर को बैकग्राउंड में चलते रहने दें।",
      ...
      resetPreferences: {
        ...
        confirmDescription:
          "केवल-स्थानीय प्राथमिकताएं साफ़ करता है और Unslothed को फिर से लोड करता है। चैट, API एक्सेस, और DB-समर्थित सेटिंग्स बनी रहती हैं।",
      ...
      permissions: {
        ...
        bypassDescription:
          "चैट के टूल कॉल (टर्मिनल, python, वेब, MCP) चलाने से पहले Unslothed उन्हें कैसे मंज़ूरी देता है। “Full access” मोड से मंज़ूरी और कोड सैंडबॉक्स बंद हो जाते हैं।",
      },
    },
    profile: {
      title: "प्रोफ़ाइल",
      description: "Unslothed में आपकी प्रोफ़ाइल कैसे दिखती है।",
      changePicture: "प्रोफ़ाइल चित्र बदलें",
      displayName: "प्रदर्शन नाम",
      nickname: "Unslothed आपको क्या कहकर बुलाए?",
      ...
      stats: {
        title: "आपके आँकड़े",
        subtitle:
          "नीचे सब कुछ आपके अपने इतिहास से गिना जाता है। कुछ भी इकट्ठा नहीं किया जाता और न ही Unslothed को भेजा जाता है।",
        retry: "फिर कोशिश करें",
        privacyNote:
          "आँकड़े आपके Unslothed इंस्टॉल में मौजूद चैट और ट्रेनिंग इतिहास से गिने जाते हैं। कुछ भी इकट्ठा नहीं किया जाता, और Unslothed या किसी तीसरे पक्ष को कुछ नहीं भेजा जाता।",
        emptyChats:
    ...
    appearance: {
      title: "रूप-रंग",
      description: "इस डिवाइस पर Unslothed कैसा दिखता है।",
      theme: {
        title: "थीम",
        label: "रंग योजना",
      ...
      palette: {
        label: "रंग पैलेट",
        description: "लाइट और डार्क मोड में पूरे Unslothed में दिखने वाले रंग।",
        standard: "मानक",
        classic: "क्लासिक",
        minimal: "मिनिमल",
      },
      custom: {
        ...
        uiFontSize: {
          ...
          description: "Unslothed UI के लिए उपयोग होने वाला आधार आकार समायोजित करें।",
        },
        codeFontSize: {
      ...
      language: {
        title: "भाषा",
        label: "प्रदर्शन भाषा",
        description: "Unslothed द्वारा उपयोग की जाने वाली भाषा।",
    ...
    resources: {
      title: "सिस्टम",
      description: "इस Unslothed सर्वर के हार्डवेयर और स्टोरेज की निगरानी करें।",
      ...
      llamaBackend: {
        ...
        customPath: {
          ...
          bundled: "Unslothed द्वारा इंस्टॉल किया गया llama.cpp रनटाइम इस्तेमाल करता है।",
        ...
        unsupported: {
          ...
          localLink: "llama.cpp आपकी अपनी लिंक की हुई लोकल डायरेक्टरी है, इसलिए Unslothed उसे नहीं बदलेगा।",
    ...
    agents: {
      ...
      intro:
        "Claude Code, Codex, Hermes, OpenClaw, OpenCode और दूसरे एजेंट को Unslothed द्वारा लोकली सर्व किए गए मॉडल से जोड़ता है, पूरी तरह ऑफ़लाइन। यह एक OpenAI-संगत सर्वर चलाता है और आपके एजेंट की कॉन्फ़िगरेशन फ़ाइलों को कभी नहीं छूता।",
      ...
      modelNote:
        "Codex को llama-server द्वारा सर्व किया गया GGUF मॉडल चाहिए। दूसरे एजेंट Transformers-आधारित मॉडल भी उपयोग कर सकते हैं; Unslothed में पहले से लोड किए गए मॉडल का उपयोग करने के लिए --model हटा दें।",
      subagent: {
        title: "लोकल मॉडल को सबएजेंट के रूप में उपयोग करें",
        description:
          "{agent} को उसके मौजूदा मॉडल पर ही रहने दें और चुने हुए काम इस लोकल Unslothed मॉडल को सौंपें।",
      ...
      options: {
        ...
        description:
          "Unslothed के फ़्लैग पहले पढ़े जाते हैं; जो पहचान में नहीं आता वह सीधे एजेंट को भेज दिया जाता है।",
        model:
        ...
        persist:
          "Unslothed द्वारा प्रबंधित एजेंट स्टोरेज को रनों के बीच बनाए रखता है।",
        asSubagent:
          "मूल एजेंट को उसके मौजूदा मॉडल पर रखता है और Unslothed को लोकल सबएजेंट के रूप में दर्ज करता है (Claude Code, Codex और OpenCode)।",
        apiKey:
          "आपकी Unslothed API key लेता है (या UNSLOTH_API_KEY सेट करें)।",
        yolo:
      ...
      passthrough: {
        ...
        description:
          "Unslothed के फ़्लैग के बाद दिए गए आर्ग्युमेंट सीधे एजेंट को भेजे जाते हैं, इसलिए resume जैसे एजेंट के अपने कमांड काम करते रहते हैं:",
      },
      dryRun: {
    ...
    apiKeys: {
      title: "API",
      description: "OpenAI-संगत API के माध्यम से Unslothed तक पहुंचें।",
      ...
      secureHttpsHint:
        "0.0.0.0 वाला पोर्ट अब भी विश्व स्तर पर पहुँचा जा सकता है। पूरी सुरक्षा के लिए Unslothed को --secure के साथ शुरू करें, ताकि केवल यह HTTPS लिंक उपलब्ध हो।",
    ...
    about: {
      ...
      studioVersion: "Unslothed संस्करण",
      ...
      shutDownStudio: "Unslothed शट डाउन करें",
      shutDownStudioDescription:
        "Unslothed सर्वर को रोकता है और आपके सत्र को समाप्त करता है।",
      shutDown: "शट डाउन करें",
      update: {
        title: "Unslothed अपडेट करें",
        commandText: "{label} का टेक्स्ट",
        copied: "कॉपी किया गया",
        copyCommand: "कमांड कॉपी करें",
        commandCopied: "{label} कॉपी किया गया",
        copyNamedCommand: "{label} कॉपी करें",
        checkingInstall: "जांच रहे हैं कि Unslothed कैसे इंस्टॉल किया गया था...",
        installIntro: "Unslothed इंस्टॉल या अपडेट करने के लिए:",
        ...
        restartAfterUpdate: "अपडेट करने के बाद Unslothed को पुनः आरंभ करें।",
        desktopManaged:
        ...
        desktopCurrentDescription: "Unslothed अपने-आप जाँच करता रहेगा।",
        ...
        unknownInstall:
          "यह पता नहीं लगाया जा सका कि Unslothed कैसे इंस्टॉल किया गया था। इंस्टॉलर या PyPI इंस्टॉल के लिए, ऊपर दिए गए कमांड का उपयोग करें।",
        localCheckout:
  ...
  studio: {
    ...
    training: {
      ...
      startUnconfirmed:
        "Unslothed यह पुष्टि नहीं कर सका कि ट्रेनिंग शुरू हुई या नहीं। बैकग्राउंड में स्थिति जांची जा रही है।",
  ...
  chat: {
    draftModelPicker: {
      autoLoadFallbackNote:
        "यह रन सेटिंग्स से होने वाले लोड पर लागू होता है। स्वचालित लोड — API ऑटो-स्विच, निष्क्रियता के बाद रीलोड, या चैट सेटिंग्स लागू करना — इसके बजाय स्वतः पहचाने गए ड्राफ़्ट मॉडल चयन पर वापस चले जाते हैं।",
    },
  },
  toolAudit: {
    title: "टूल गतिविधि",
    empty: "अभी तक कोई टूल कॉल दर्ज नहीं हुई।",
    loadError: "टूल गतिविधि लोड नहीं हो सकी। पुनः प्रयास करें।",
    degraded: "कुछ ऑडिट रिकॉर्ड लिखे नहीं जा सके ({count})। लॉग अधूरा है।",
    filterTool: "टूल के अनुसार फ़िल्टर करें",
    filterAll: "सभी टूल",
    columnTime: "समय",
    columnTool: "टूल",
    columnOutcome: "स्थिति",
    columnDuration: "अवधि",
    outcomeRunning: "चल रहा है",
    outcomeOk: "सफल",
    outcomeError: "त्रुटि",
    redactedBadge: "संपादित",
    sandboxBypassBadge: "सैंडबॉक्स बायपास किया गया",
    argumentsHeading: "आर्गुमेंट्स",
    resultHeading: "परिणाम",
    errorHeading: "त्रुटि",
    truncatedNote: "{bytes} बाइट्स में से पहले और अंतिम 4 KB दिखाए जा रहे हैं।",
