...
export const de = {
  ...
  shell: {
    ...
    selection: {
      ...
      deleteProjectFolderKeptDescription:
        "Chats werden gelöscht. Der von Ihnen gewählte Ordner ({path}) bleibt auf der Festplatte erhalten.",
  ...
  settings: {
    ...
    dialog: {
      title: "Einstellungen",
      description: "Verwalten Sie Ihre Unslothed-Einstellungen.",
    ...
    voice: {
      ...
      dictation: {
        ...
        micAccessBlocked:
          "Der Mikrofonzugriff wurde blockiert. Erlauben Sie den Mikrofonzugriff für diese Unslothed-Seite und versuchen Sie es erneut.",
    ...
    general: {
      title: "Allgemein",
      description: "Globale Einstellungen für Unslothed.",
      account: "Konto",
      ...
      password: "Passwort",
      passwordDescription:
        "Ändern Sie das Passwort für dieses Unslothed-Konto.",
      passwordDialog: {
        ...
        setDescription:
          "Wählen Sie das Passwort, mit dem sich entfernte Browser als unsloth anmelden (mindestens {minLength} Zeichen). Die Unslothed Desktop-App meldet sich weiterhin automatisch an.",
      ...
      startup: {
        ...
        launchAtLogin: "Unslothed bei der Anmeldung starten",
        launchAtLoginDescription:
          "Startet Unslothed im Hintergrund, wenn Sie sich anmelden. Es bleibt in der Menüleiste bzw. im Infobereich, bis Sie es öffnen.",

        closeToTray: "In den Infobereich schließen",
        closeToTrayDescription:
          "Unslothed und seinen Server im Hintergrund weiterlaufen lassen, wenn Sie das Hauptfenster schließen.",
      ...
      resetPreferences: {
        ...
        confirmDescription:
          "Löscht nur lokal gespeicherte Einstellungen und lädt Unslothed neu. Chats, API-Zugriff und in der DB gespeicherte Einstellungen bleiben erhalten.",
      ...
      permissions: {
        ...
        bypassDescription:
          "Wie Unslothed Tool-Aufrufe im Chat (Terminal, Python, Web, MCP) vor der Ausführung freigibt. „Full access“ deaktiviert die Freigaben und die Code-Sandbox.",
      },
    },
    profile: {
      title: "Profil",
      description: "Wie Ihr Profil in Unslothed angezeigt wird.",
      changePicture: "Profilbild ändern",
      displayName: "Anzeigename",
      nickname: "Wie soll Unslothed Sie nennen?",
      ...
      stats: {
        ...
        subtitle:
          "Alles Folgende wird aus Ihrem eigenen Verlauf berechnet. Es wird nichts erfasst oder an Unslothed gesendet.",
        retry: "Erneut versuchen",
        privacyNote:
          "Die Statistiken werden aus dem Chat- und Trainingsverlauf berechnet, der in Ihrer Unslothed-Installation gespeichert ist. Es wird nichts erfasst und nichts an Unslothed oder Dritte gesendet.",
        emptyChats:
    ...
    appearance: {
      title: "Darstellung",
      description: "Wie Unslothed auf diesem Gerät aussieht.",
      theme: {
        title: "Design",
        label: "Farbschema",
      ...
      palette: {
        label: "Farbpalette",
        description: "Farben, die in Unslothed im hellen und dunklen Modus verwendet werden.",
        standard: "Standard",
        classic: "Klassisch",
        minimal: "Minimal",
      },
      custom: {
        ...
        uiFontSize: {
          ...
          description: "Passen Sie die Grundgröße der Unslothed-Oberfläche an.",
        },
        codeFontSize: {
      ...
      language: {
        ...
        description: "Die von Unslothed verwendete Sprache.",
    ...
    resources: {
      title: "System",
      description:
        "Überwachen Sie Hardware und Speicher dieses Unslothed-Servers.",
      ...
      llamaBackend: {
        ...
        customPath: {
          ...
          bundled: "Verwendet die von Unslothed installierte llama.cpp-Laufzeit.",
        ...
        unsupported: {
          notInstalled: "Es wurde keine von Unslothed verwaltete llama.cpp-Installation gefunden, daher gibt es kein Backend zum Wechseln.",
          localLink: "llama.cpp ist ein selbst verknüpftes lokales Verzeichnis, das Unslothed nicht ersetzt.",
    ...
    agents: {
      ...
      intro:
        "verbindet Claude Code, Codex, Hermes, OpenClaw, OpenCode und weitere Agenten mit einem lokal von Unslothed bereitgestellten Modell, vollständig offline. Es startet einen OpenAI-kompatiblen Server und verändert nie die Konfigurationsdateien Ihres Agenten.",
      ...
      modelNote:
        "Codex benötigt ein GGUF-Modell, das von llama-server bereitgestellt wird. Andere Agenten können auch Transformer-basierte Modelle verwenden; lassen Sie --model weg, um das bereits in Unslothed geladene Modell zu nutzen.",
      subagent: {
        title: "Ein lokales Modell als Subagent verwenden",
        description:
          "Belassen Sie {agent} bei seinem aktuellen Modell und delegieren Sie ausgewählte Aufgaben an dieses lokale Unslothed-Modell.",
      ...
      options: {
        ...
        description:
          "Unslothed-Optionen werden zuerst ausgewertet; alles Unbekannte wird unverändert an den Agenten weitergereicht.",
        model:
        ...
        persist:
          "Behält die von Unslothed verwalteten Agent-Daten über Läufe hinweg bei.",
        asSubagent:
          "Belässt den übergeordneten Agenten bei seinem aktuellen Modell und registriert Unslothed als lokalen Subagenten (Claude Code, Codex und OpenCode).",
        apiKey:
          "Übergibt Ihren Unslothed-API-Schlüssel (alternativ UNSLOTH_API_KEY setzen).",
        yolo:
      ...
      passthrough: {
        ...
        description:
          "Argumente nach den Unslothed-Optionen werden an den Agenten selbst weitergereicht, sodass native Befehle wie resume weiterhin funktionieren:",
      },
      dryRun: {
    ...
    apiKeys: {
      title: "API",
      description: "Zugriff auf Unslothed über die OpenAI-kompatible API.",
      ...
      secureHttpsHint:
        "Der 0.0.0.0-Port ist weiterhin global erreichbar. Für vollständige Sicherheit starten Sie Unslothed mit --secure, um nur diesen HTTPS-Link freizugeben.",
    ...
    about: {
      ...
      studioVersion: "Unslothed-Version",
      ...
      shutDownStudio: "Unslothed herunterfahren",
      shutDownStudioDescription:
        "Stoppt den Unslothed-Server und beendet Ihre Sitzung.",
      shutDown: "Herunterfahren",
      update: {
        title: "Unslothed aktualisieren",
        commandText: "{label} als Text",
        copied: "Kopiert",
        copyCommand: "Befehl kopieren",
        commandCopied: "{label} kopiert",
        copyNamedCommand: "{label} kopieren",
        checkingInstall: "Es wird geprüft, wie Unslothed installiert wurde...",
        installIntro: "So installieren oder aktualisieren Sie Unslothed:",
        ...
        restartAfterUpdate: "Starten Sie Unslothed nach dem Update neu.",
        desktopManaged:
        ...
        desktopCurrentDescription:
          "Unslothed sucht weiterhin automatisch nach Updates.",
        ...
        unknownInstall:
          "Es konnte nicht erkannt werden, wie Unslothed installiert wurde. Verwenden Sie für Installer- oder PyPI-Installationen die obigen Befehle.",
        localCheckout:
  ...
  studio: {
    ...
    training: {
      ...
      startUnconfirmed:
        "Unslothed konnte nicht bestätigen, ob das Training gestartet wurde. Der Status wird im Hintergrund geprüft.",
    ...
    trainingStart: {
      ...
      terminalStart: "> Unslothed-Training beginnt...",
  ...
  chat: {
    draftModelPicker: {
      autoLoadFallbackNote:
        "Gilt für Ladevorgänge aus den Ausführungseinstellungen. Automatische Ladevorgänge — API-Autowechsel, Neuladen nach Leerlauf oder das Anwenden von Chat-Einstellungen — greifen stattdessen auf die automatisch erkannte Entwurfsmodell-Auswahl zurück.",
    },
  },
  toolAudit: {
    ...
    columnTime: "Zeit",
    columnTool: "Tool",
    columnOutcome: "Status",
    columnDuration: "Dauer",
    outcomeRunning: "läuft",
    outcomeOk: "erfolgreich",
    outcomeError: "Fehler",
    redactedBadge: "geschwärzt",
    sandboxBypassBadge: "Sandbox umgangen",
    argumentsHeading: "Argumente",
    resultHeading: "Ergebnis",
    errorHeading: "Fehler",
    truncatedNote: "Zeigt die ersten und letzten 4 KB von {bytes} Bytes.",
