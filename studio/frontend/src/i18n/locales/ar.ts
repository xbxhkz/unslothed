...
export const ar = {
  ...
  shell: {
    ...
    selection: {
      ...
      deleteProjectFolderKeptDescription:
        "ستُحذف الدردشات. سيبقى المجلد الذي اخترته ({path}) على القرص.",
  ...
  toolAudit: {
    title: "نشاط الأدوات",
    empty: "لم يتم تسجيل أي استدعاءات أدوات حتى الآن.",
    loadError: "تعذّر تحميل نشاط الأدوات. حاول التحديث.",
    degraded: "فشلت كتابة بعض سجلات التدقيق ({count}). السجل غير مكتمل.",
    filterTool: "التصفية حسب الأداة",
    filterAll: "جميع الأدوات",
    columnTime: "الوقت",
    columnTool: "الأداة",
    columnOutcome: "الحالة",
    columnDuration: "المدة",
    outcomeRunning: "قيد التشغيل",
    outcomeOk: "ناجح",
    outcomeError: "خطأ",
    redactedBadge: "محجوب",
    sandboxBypassBadge: "تم تجاوز العزل",
    argumentsHeading: "المعطيات",
    resultHeading: "النتيجة",
    errorHeading: "الخطأ",
    truncatedNote: "عرض أول وآخر 4 كيلوبايت من أصل {bytes} بايت.",
    refresh: "تحديث",
  },
